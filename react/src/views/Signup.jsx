...
export default function Signup() {
    ...
    const backgroundStyle = {
        ...
        backgroundImage: `linear-gradient(rgba(50,34,30,0.75), rgba(50,34,30,0.75)), url(${backgroundImageUrl})`,
        ...
        <div style={backgroundStyle}>
            ...
            <nav style={navStyle}>
                <div style={navLeftStyle}>
                    <div style={{ ...logoStyle, fontSize: '1.4rem', fontWeight: '700' }}>Library System</div>
                ...
                {!showServices && (
                    <div style={formStyle}>
                        <form onSubmit={onSubmit}>
                            <h1 style={{ marginBottom: '24px', fontWeight: '700', fontSize: '1.8rem' }}>Create your account</h1>
                            <input ref={nameRef} placeholder="Full Name" style={inputStyle} />
                            ...
                            <input ref={passwordConfirmationRef} type="password" placeholder="Confirm Password" style={inputStyle} />
                            <button
                                style={buttonStyle}
                            ...
                            <p style={{ marginTop: '20px', color: '#5a4632', fontStyle: 'italic' }}>
                                ...
                                <Link to="/login" style={{ color: '#7c6447', textDecoration: 'underline', marginLeft: '5px' }}>
                                    Sign in
                                </Link>
                            </p>
                        </form>
                ...
                {showServices && (
                    ...
                    >
                        ...
                        <ul style={{ margin: '20px 0' }}>
                            <li>📚 Service 1: Book lending and returns</li>
                            <li>💻 Service 2: Online catalog and account</li>
                            <li>🔖 Service 3: Reservation and event booking</li>
                        </ul>
                        <button
